...
import 'package:smart_truck_app/features/registration/presentation/pages/to_complete_profile/verification_pending.dart';
import 'package:smart_truck_app/features/registration/presentation/pages/to_home_page/to_home_page.dart';
...
class RouteGenerator {
  static Route<dynamic> getRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      // case Routes.documentUploadScreen:
